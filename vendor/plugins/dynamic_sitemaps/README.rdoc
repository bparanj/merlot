Implement pagination on the articles page.
When FB like button is clicked, make the clicked link display all the details of that specific article instead of generic message.
